        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="mb-6">
            <Link to="/" className="flex items-center mb-4">
              <img src="/images/final logo black SVG.svg" alt="Skull Engine" className="w-12 mr-2" />
              <span className="text-white font-bold text-xl">SkullEngine</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/animation" className="text-gray-400 hover:text-white transition-colors">Animation</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Email: contact@skullengine.com<br />
