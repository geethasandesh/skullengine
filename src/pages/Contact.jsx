...
function Contact() {
  // EmailJS keys (hardcoded per your request)
  const EMAILJS_SERVICE_ID = 'service_nzxk7ib';
  const EMAILJS_TEMPLATE_ID = 'template_a2roumw';
  const EMAILJS_PUBLIC_KEY = 'uViGWSlhN62TJXwBn';
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      link: 'tel:+914040103376'
    },
    {
      title: 'Visit Us',
      info: 'Gachibowli , Hyderabad',
    ...
    },
    {
      ...
      link: 'https://www.instagram.com/skullenginestudio?igsh=MTM3emFteWkyeDBxbQ=='
    }
  ];
